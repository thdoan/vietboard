...
<div class="button-container icons">
  ...
  <button id="highscores" class="icon" title="${t('High Scores')}" onclick="g_bui.showHighScores()">
  ...
  <button id="react" class="icon" title="${t('Send reaction')}" onclick="g_bui.showEmojiPicker()">
  ...
  <button id="restart" class="icon" title="${t('Restart')}" onclick="confirmRestartIfNeeded()">
    <svg viewBox="0 0 24 24">
